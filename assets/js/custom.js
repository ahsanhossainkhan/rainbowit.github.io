(function ($){
    ...
    // change theme
    var ColorChangeIcon=document.querySelector('.themeChangeIcon');
    ColorChangeIcon.addEventListener('click',function(){
        document.body.classList.toggle('light-theme');
        if(document.body.classList.contains('light-theme')){
            ColorChangeIcon.classList.add('icofont-moon');
        }
        else{
            ColorChangeIcon.classList.remove('icofont-moon');
        };
    });
